...
export const MODULES = [
  ...
  { id: "markets-regulation", trackId: "markets", title: "Regulatory framework", order: 20, level: 400, description: "The '33/'34 Acts & SEC, FINRA, MSRB, the SIE/Series 7 framework, U4/U5 registration, prohibited practices, recordkeeping & reporting, and AML." },
  { id: "markets-muni-debt", trackId: "markets", title: "Municipal & debt securities", order: 21, level: 400, description: "GO vs revenue bonds, municipal taxation & tax-equivalent yield, yield-to-worst & basis pricing, callable/refunded/convertible/put bonds, money-market instruments, and muni exam math." },
  { id: "markets-accounts", trackId: "markets", title: "Accounts & processing", order: 22, level: 400, description: "Account types & authority, options/margin account docs, account opening & CIP, confirmations & T+1 settlement, books & records, and delivery edge cases." },
  { id: "markets-communications", trackId: "markets", title: "Seeking business & communications", order: 23, level: 400, description: "FINRA Rule 2210 communication categories, approval & filing, content standards, testimonials, telemarketing & cold calling, social media, and recommendation disclosures." },
