  ...
  sections: [
    ...
    { type: "heading", text: "MSRB rules to know exist" },
    {
      ...
      items: [
        ...
        "**Best execution**.",
        "The **gift rule** — `MSRB Rule G-20`, a `$300` per person per year limit on gifts related to muni business (raised from `$100` in 2026 to harmonize with FINRA `Rule 3220`).",
      ],
    },
    ...
    },
    {
      ...
      terms: [
        ...
        { term: "MSRB Rule G-20", def: "The muni gift rule — a $300 per person per year limit for gifts related to municipal business (raised from $100 in 2026, harmonized with FINRA Rule 3220)." },
